...
### Agenda
### <strong>1. Digital Signatures: ECDSA Fundamentals</strong>
- [Digital Signatures (ECDSA)](https://github.com/bitcoinbook/bitcoinbook/blob/develop/ch04_keys.adoc)
- [Public Key Cryptography](https://github.com/bitcoinbook/bitcoinbook/blob/develop/ch04_keys.adoc)
- [Private and Public Keys](https://github.com/bitcoinbook/bitcoinbook/blob/develop/ch04_keys.adoc)
- [The secp256k1 Curve](https://github.com/bitcoinbook/bitcoinbook/blob/develop/ch04_keys.adoc)

### <strong>2. How Signing Works</strong>
...
## <strong>3. Practical Demo: Signing a Transaction</strong>
- [Serializing a Transaction for Signing](https://github.com/bitcoinbook/bitcoinbook/blob/develop/ch06_transactions.adoc)
- [Generating a Signature from a Private Key](https://github.com/bitcoinbook/bitcoinbook/blob/develop/ch04_keys.adoc)
- [Attaching the Signature (scriptSig / Witness)](https://github.com/bitcoinbook/bitcoinbook/blob/develop/ch06_transactions.adoc)
- [Live Walkthrough: Sign and Broadcast](https://github.com/bitcoinbook/bitcoinbook/blob/develop/ch06_transactions.adoc)
